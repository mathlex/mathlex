...
grammar =
    ...
    algebraic: [
        ...
        o 'algebraic TSelfCompose algebraic',           -> ['SelfCompose', $1, $3]
        ...
        o 'TBigUnion range_bounds algebraic',           -> ['Function', ['Variable', 'Union'], [$3].concat($2)]
        o 'TBigIntersect range_bounds algebraic',       -> ['Function', ['Variable', 'Intersect'], [$3].concat($2)]
        ...
        o 'algebraic TChoose algebraic',                -> ['Function', ['Variable', 'combination'], [$1].concat([$3])]
